from AverageMiniProject.Version_2.Version_2_1.input import Input, bcolors
import sys
...
class Calculate(Input):
    ...
    def do_math(self):
        ...
        self.sum_divisions = self.division_values[0] * 1 + self.division_values[1] * 2 +\
                             self.division_values[2] * 3 + self.division_values[3] * 4
